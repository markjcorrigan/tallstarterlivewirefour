...
class ManageTeam extends Component
{
    ...
    public function inviteUser(): void
    {
        ...
        try {
            ...
            $this->dispatch('alert', type: 'success', message: __('teams.invitation_sent'));
    ...
    public function updateRole(): void
    {
        ...
        try {
            ...
            $this->dispatch('alert', type: 'success', message: __('teams.role_updated'));
    ...
    public function removeUser(User $user): void
    {
        ...
        try {
            ...
            $this->dispatch('alert', type: 'success', message: __('teams.user_removed'));
